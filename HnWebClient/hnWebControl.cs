    ...
    public class hnWebControl
    {
        ...
        public bool queryTestItemInf(Hashtable ht, out DataTable dtack, out string result, out string errMsg)
        {
            ...
            try
            {
                ...
                {
                    dtack = ds.Tables["list"];
                    enableASM = dtack.Rows[0]["asm"].ToString() == "1";
                    enableVMAS = dtack.Rows[0]["vmas"].ToString() == "1";
                    enableSDS = dtack.Rows[0]["tsi"].ToString() == "1";
                    enableLUGDOWN = dtack.Rows[0]["ld"].ToString() == "1";
                    enableZYJS = dtack.Rows[0]["snap"].ToString() == "1";
                    enableLZ = dtack.Rows[0]["ftst"].ToString() == "1";
