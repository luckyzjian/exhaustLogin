        ...
        public ASM_XZDB Get_ASM_XZDB(string ID)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    asm_xzdb.HC5025 = float.Parse(dt.Rows[0]["d1Date20000701qHC5025"].ToString());
                    asm_xzdb.CO5025 = float.Parse(dt.Rows[0]["d1Date20000701qCO5025"].ToString());
                    asm_xzdb.NO5025 = float.Parse(dt.Rows[0]["d1Date20000701qNO5025"].ToString());
                    asm_xzdb.HC2540 = float.Parse(dt.Rows[0]["d1Date20000701qHC2540"].ToString());
                    asm_xzdb.CO2540 = float.Parse(dt.Rows[0]["d1Date20000701qCO2540"].ToString());
                    asm_xzdb.NO2540 = float.Parse(dt.Rows[0]["d1Date20000701qNO2540"].ToString());
                    asm_xzdb.HC5025H = float.Parse(dt.Rows[0]["d1Date20000701HC5025"].ToString());
                    asm_xzdb.CO5025H = float.Parse(dt.Rows[0]["d1Date20000701CO5025"].ToString());
                    asm_xzdb.NO5025H = float.Parse(dt.Rows[0]["d1Date20000701NO5025"].ToString());
                    asm_xzdb.HC2540H = float.Parse(dt.Rows[0]["d1Date20000701HC2540"].ToString());
                    asm_xzdb.CO2540H = float.Parse(dt.Rows[0]["d1Date20000701CO2540"].ToString());
                    asm_xzdb.NO2540H = float.Parse(dt.Rows[0]["d1Date20000701NO2540"].ToString());
