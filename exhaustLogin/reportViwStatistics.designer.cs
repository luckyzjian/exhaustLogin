...
{
    partial class reportViwStatistics
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource1.Value = this.已检车辆信息BindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "exhaustLogin.ReportStatistics.rdlc";
