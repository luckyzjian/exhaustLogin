...
{
    public partial class reportViwAniStatistics : Form
    {
        SYS_DAL.loginInfControl logininfcontrol = new SYS_DAL.loginInfControl();
        public reportViwAniStatistics()
        {
            InitializeComponent();
        }
        ...
        public void display_Asm(DateTime starttime)
        {
            int totalCount = 0;
            int OKcount = 0;
            int notOkcount = 0;
            ...
            try
            {
                DataSet model = logininfcontrol.getAniDataset(starttime);
