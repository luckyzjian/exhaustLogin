...
namespace exhaustDetect
{
    public partial class reportViewZJSdsCH : Form
    {
        ...
        public void display_Vmas(string clid)
        {
            ...
            init_wsd();
            string lambdapd = "/";
            if (carinf.JHZZ == "是" || carinf.JHZZ == "有")
            ...
            try
            {
                ReportParameter[] rptpara =
                {
                    ...
                    new ReportParameter("parameterChzz",(carinf.JHZZ=="是"||carinf.JHZZ=="有")?"有":"无"),
