        ...
        public void display_Vmas(string clid)
        {
            ...
            try
            {
                ReportParameter[] rptpara =
                {
                    ...
                    new ReportParameter("parameterHCXZ",vmas_data.BEFORE=="Y"?"≤"+vmas_data.HCXZ:"—"),
                    new ReportParameter("parameterHCPD",vmas_data.BEFORE=="Y"?((vmas_data.HCPD=="合格")?"〇":"×"):"—"),

                    new ReportParameter("parameterNOXCLZ",(float.Parse(vmas_data.NOXZL)).ToString("0.00")),
                    new ReportParameter("parameterNOXXZ",vmas_data.BEFORE=="Y"?"≤"+vmas_data.NOXXZ:"—"),
                    new ReportParameter("parameterNOXPD",vmas_data.BEFORE=="Y"?((vmas_data.NOXPD=="合格")?"〇":"×"):"—"),

                    new ReportParameter("parameterHCNOXCLZ",(float.Parse(vmas_data.HCZL)+float.Parse(vmas_data.NOXZL)).ToString("0.00")),
                    new ReportParameter("parameterHCNOXXZ",vmas_data.BEFORE=="N"?("HC+NOx≤"+vmas_data.HCXZ):"—"),
                    new ReportParameter("parameterHCNOXPD",vmas_data.BEFORE=="N"?((vmas_data.HCPD=="合格")?"〇":"×"):"—"),
