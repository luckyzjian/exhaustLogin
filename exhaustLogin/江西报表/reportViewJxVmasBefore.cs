...
{
    public partial class reportViewJxVmasBefore : Form
    {
        ...
        public void display_VmasAfter(string clid)
        {
            ...
            try
            {
                ...
                {
                    new ReportParameter("parameterJCYJ","GB18285-2005,DB36/617-2011"),
                    new ReportParameter("parameterCMABH", mainPanel.CMABH),
                    new ReportParameter("parameterCMAYXQ",mainPanel.CMAYXQ),
                    new ReportParameter("parameterXKZH", mainPanel.XKZH),
                    new ReportParameter("parameterXKZYXQ", mainPanel.XKZYXQ),
                    new ReportParameter("parameterBbbt",mainPanel.addname+"机动车排气污染物检测报告单"),
                    new ReportParameter("parameterJCFF","简易瞬态工况法"),
                    new ReportParameter("parameterLsh",carinf.STATIONID.Substring(0,6)+carinf.JCSJ.ToString("yyMMdd")+carinf.STATIONID.Substring(6,carinf.STATIONID.Length-6)+carinf.LINEID+ carinf.LSH.Remove(0,carinf.LSH.Count()-3)),
                    ...
                    new ReportParameter("parameterWgjyy", mainPanel.wgjcy),
                ...
                new ReportParameter("parameterZHPD",(vmas_data.ZHPD=="合格")?"〇":"×"),
                    ...
                    new ReportParameter("parameterJczdh",mainPanel.otherinf.FWDH+"(检测单位)"+"   "+mainPanel.otherinf.JDDH+"(环境保护局)"),
        ...
        public void display_Lugdown(string clid)
        {
            ...
            try
            {
                ReportParameter[] rptpara =
                {
                   new ReportParameter("parameterJCYJ","GB3847-2005,DB36/618-2011"),
                    new ReportParameter("parameterCMABH", mainPanel.CMABH),
                    new ReportParameter("parameterCMAYXQ",mainPanel.CMAYXQ),
                    new ReportParameter("parameterXKZH", mainPanel.XKZH),
                    new ReportParameter("parameterXKZYXQ", mainPanel.XKZYXQ),
                   ...
                   new ReportParameter("parameterDly", carinf.DLY),
                    ...
                    new ReportParameter("parameterLBGL",(Math.Round(double.Parse(asm_data.MAXLBGL)*50.0/double.Parse(asm_data.GLXZ),1)).ToString("0.0")),
