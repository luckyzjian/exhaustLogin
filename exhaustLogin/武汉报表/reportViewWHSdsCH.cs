    ...
    public partial class reportViewWHSdsCH : Form
    {
        ...
        public void display_Vmas(string clid)
        {
            ...
            if (carinf.JHZZ != "无"&&carinf.JHZZ!="否")
                lambdapd = asm_data.LAMDAHIGHPD==""? "/" :asm_data.LAMDAHIGHPD;
                ...
                ReportParameter[] rptpara =
                                {
                                    ...
                                    new ReportParameter("parameterJsy", carinf.JSY),
                                     ...
                                     new ReportParameter("parameterQdltqy", carinfo.QDLTQY),
