        ...
        public void display_Asm(string clid)
        {
            ...
            try
            {
                ReportParameter[] rptpara =
                {
                    ...
                    new ReportParameter("parameterCO25CLZ",(asm_data.CO25CLZ=="0.00"||asm_data.CO25CLZ=="0.0")?"0.01":asm_data.CO25CLZ),
                    new ReportParameter("parameterNOX25CLZ",asm_data.NOX25CLZ),
                    new ReportParameter("parameterHC40CLZ",asm_data.HC40CLZ),
                    new ReportParameter("parameterCO40CLZ",(asm_data.CO40CLZ=="0.00"||asm_data.CO40CLZ=="0.0")?"0.01":asm_data.CO40CLZ),
                    ...
                    new ReportParameter("parameterLambda5025",asm_data.LAMBDA5025),
                    new ReportParameter("parameterLambda2540",asm_data.LAMBDA2540),
