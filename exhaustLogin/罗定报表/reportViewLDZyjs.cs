        ...
        public void display_Vmas(string clid)
        {
            ...
            try
            {
                ReportParameter[] rptpara =
                {
                    ...
                    new ReportParameter("parameterDSZS",asm_data.DSZS=="0"?"-":asm_data.DSZS),
                    ...
                    new ReportParameter("parameterBgffyy",carinf.BGFFYY==""?"":"(检测方法更改原因："+carinf.BGFFYY+")"),
