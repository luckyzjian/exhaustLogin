        ...
        public void display_Vmas(string clid)
        {
            ...
            try
            {
                ReportParameter[] rptpara =
                {
                    ...
                    new ReportParameter("parameterQfrq", DateTime.Now.ToString("yyyy-MM-dd")),
                    ...
                    new ReportParameter("parameterFdjxh",carinf.FDJXH+"/"+carinf.FDJPL),
