...
{
    public partial class report票据 : Form
    {
        ...
        public void display_Asm()
        {
            ...
            try
            {
                ...
                ReportParameter[] rptpara =
                        {
                            new ReportParameter("clid", "川AV7M82"),
                            new ReportParameter("cz","周建"),
                            new ReportParameter("safestandard","100.0"),
                            new ReportParameter("safefact", "100.0"),
                            new ReportParameter("safebz", "100.0"),
                            new ReportParameter("exhauststandard", "100.0"),
                            new ReportParameter("exhaustfact","100.0"),
                            new ReportParameter("exhaustbz", "100.0"),
                            new ReportParameter("money", "100.0"),
                            new ReportParameter("moneyinchinese", RMBCapitalization.MoneyToUpper("100.0")),
