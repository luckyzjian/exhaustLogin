...
{
    /// <summary>
    /// 附加功率损失检查记录 POST /rest/additionalData/
    /// </summary>
    ...
    /// <summary>
    /// 分析仪检查记录 POST /rest/analyzerData/
    /// </summary>
    public class AnalyzerInspectionData
    {
        ...
        public AnalyzerInspectionData(string co2Concentration, string co2Result, string coConcentration, string coResult,
            ...
            string stationNumber, string type, string userId)
        {
    ...
    public class AnalyzerOxygenRangeData
    {
        ...
        public AnalyzerOxygenRangeData(string examinationResult, string id, string insertTime, string inspectionDate,
            string inspectionStartTime, string lineNumber, string oxygenRangeError, string oxygenRangeMValue, string oxygenRangeValue,
             string remark, string stationNumber, string type, string userId)
        {
            this.examinationResult = examinationResult;
            this.id = id;
            this.insertTime = insertTime;
    ...
    public class EzCodModelslibrarycatalogue
    {
        ...
        public EzCodModelslibrarycatalogue(string bsqxs, string carNum, string carcolor, string cllb, string edgl, 
            ...
            string fdate, string hasAftertreatmentDevice, string hasEgr, string hasElectronicControl, 
            ...
            string ownerName, string ownerPhone, string pf, string plateType, string pqhclxs, string qdfs, 
            string rlggxs, string rllx, string sb, string scqymc, string vId, string veModel, string vehicleSerialNumber,
            string vehicleState, string vin, string zdzzl)
        {
            this.bsqxs = bsqxs;
    ...
    public class EzIfaJcDoubleidlelog
    {
        ...
        public EzIfaJcDoubleidlelog(string analysEro2, string conditionType, string excessAirCoefficientIn,
            ...
            string samplingSequence, string wholeTimeSequence)
        {
    ...
    /// <summary>
    /// 自由加速不透光烟度法检验过程中采集的检验过程数据
    /// </summary>
    public class EzIfaJcLightproofdata
    {
        public string path = "/rest/lightproof/";
        ...
        public EzIfaJcLightproofdata(string checktimeend, string checktimestart, string engineSpeed, 
            string id, string inserttime, string opacitySmokeValue, string samplingTiming,
            string userid, string workingClass)
        {
    ...
    public class InspectionInformation
    {
        ...
        public InspectionInformation(string examinationResult, string id, string inspectionEndTime, string inspectionMethod, 
            ...
            string hasAftertreatmentDevice, string pqhclxs, string hasObd
            )
        {
            this.examinationResult = examinationResult;
    ...
    public class LeakCheckData
    {
        ...
        public LeakCheckData(string examinationResult, string id, string insertTime, string inspectionDate,
            string inspectionStartTime, string lineNumber, string remark, string stationNumber, string userId)
        {
            this.examinationResult = examinationResult;
    ...
    public class EzIfaJcLoaddowndata
    {
        ...
        public EzIfaJcLoaddowndata(string airPressure, string emissionDetermination, string emissionLimit, 
    ...
    public class EzIfaJcLoaddownlog
    {
        ...
        public EzIfaJcLoaddownlog(string conditionType, string dynamometerLoad, string id, string inspectornum, 
    ...
    public class SteadyStateMethodData
    {
        ...
        public string inspectionreport;
        public string linenumber;
        public string hcResultFive;
        public string coResultFive;
        public string noResultFive;
        public string enginespeedfive;
        public string temperaturefive;
        public string hcResultTwo;
        public string coResultTwo;
        public string noResultTwo;
        public string enginespeedtwo;
        public string temperaturetwo;
        public string hcLimitValueFive;
        public string coLimitValueFive;
        public string noLimitValueFive;
        public string hcLimitValueTwo;
        public string coLimitValueTwo;
        public string noLimitValueTwo;
        public string hcDetermineFive;
        public string coDetermineFive;
        public string noDetermineFive;
        public string hcDetermineTwo;
        public string coDetermineTwo;
        public string noDetermineTwo;
        public string ambientTemperature;
        public string relativeHumidity;
        public string atmospheric;
        public string inspectionstarttime;
        public string endtime;
        ...
        public SteadyStateMethodData(string stationNumber, string inspectionReport, string lineNumber, string hcResultFive, 
            ...
            string relativeHumidity, string atmospheric, string inspectionStartTime, string endTime)
        {
            this.stationnumber = stationNumber;
            this.inspectionreport = inspectionReport;
            this.linenumber = lineNumber;
